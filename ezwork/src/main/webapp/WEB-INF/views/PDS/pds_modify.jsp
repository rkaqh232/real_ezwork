...
<div class="container">
		...
		<div class="card card-custom">
			...
			<!--begin::Form-->
			<form action="PdsModifyAction" method="post"
				enctype="multipart/form-data" name="boardform">
				<input type = "hidden" name="PDS_NO" value ="${boarddata.PDS_NO }">
				<div class="card-body">
					<div class="form-group row">
						...
						<div class="col-lg-2">
							<div class="rows">
								<select name ="PDS_SORT" class="form-control" id="viewcount">
					...
					<div class="form-group row">
						...
						<div class="col-lg-4">
							<input name="PDS_NAME" id="board_name" value="${boarddata.PDS_NAME }" readOnly
					...
					<div class="form-group row">
						...
						<div class="col-lg-7">
							<input name="PDS_TITLE" id="board_subject" type="text"
								size="50" maxlength="100" class="form-control"
								value="${boarddata.PDS_TITLE }" >
						</div>
					</div>
					<div class="form-group row">
						<label class="col-lg-3 col-form-label text-lg-right">내용</label>
						<div class="col-lg-7">
							<textarea name ="PDS_CONTENT" style="height: 325px" class="form-control">${boarddata.PDS_CONTENT }</textarea>
						</div>
					</div>
							...
							<div class="dropzone dropzone-multi" id="kt_dropzone_4">
								<div class="dropzone-panel mb-lg-0 mb-2">
									<input type="file" id="upfile" name="uploadfile"> <span
										id="filevalue">${boarddata.PDS_FILE}</span>
					...
					<div class="form-group row">
						...
						<div class="col-lg-4">
							<input type="password" class="form-control" id="pass"
								placeholder="비밀번호를 입력하세요" name="PDS_PASS">
						</div>
					</div>
				</div>
