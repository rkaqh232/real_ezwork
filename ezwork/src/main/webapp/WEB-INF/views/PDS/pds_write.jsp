...
<body>
	...
	<div class="container">
		...
		<div class="card card-custom">
			...
			<!--begin::Form-->
			<form action="PdsWriteAction" method="post"
				...
				<div class="card-body">
						...
						<div class="col-lg-2">
							<div class="rows">
								<select name ="PDS_SORT" class="form-control" id="viewcount">
									<option value="중요문서" selected>중요문서</option>
					...
					<div class="form-group row">
						...
						<div class="col-lg-4">
							<input name="PDS_NAME" id="board_name" value="관리자" readOnly
					...
					<div class="form-group row">
						...
						<div class="col-lg-7">
							<textarea name ="PDS_CONTENT" style="height: 325px" class="form-control" rows="3" placeholder="내용을 입력하세요"></textarea>
						</div>
					</div>
