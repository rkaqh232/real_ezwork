													...
													<div class="my-5 step" data-wizard-type="step-content"
														...
														<div class="form-group row">
															...
															<div class="col-lg-9 col-xl-9">
																<input
																	...
																	name="M_CODE" id="M_CODE" type="text" placeholder="ex) EMP202010" 
														...
														<div class="form-group row">
															...
															<div class="col-lg-9 col-xl-9">
																<input
																	class="form-control form-control-solid form-control-lg"
																	name="M_PASS" type="text" id="M_PASS" value="" placeholder="880920" /> <span
													...
													<!-- 직급코드 -->
														...
														<div class="form-group row">
															...
															<div class="col-lg-9 col-xl-9">
																<input
																	class="form-control form-control-solid form-control-lg"
																	name="M_NAME" type="text" id="M_NAME"  value="" placeholder="김마리"/>
															</div>
														</div>
															...
															<div class="col-lg-4 col-md-9 col-sm-12">
																<div class="input-group date">
																	<input type="text" class="form-control"
																		value="12/23/2012" id="kt_datepicker_3" name="M_BIRTH"/>
														...
														<div class="form-group row">
															...
															<div class="col-lg-9 col-xl-9">
																<label class="radio radio-rounded radio-info"> <input
																	type="radio" name="M_MARRIAGE" id="M_MARRIAGE" checked="checked" value="Y" /> 기혼 <span></span>
																	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
															...
															<div class="col-9">
																<div class="input-group input-group-solid">
																	...
																	<input type="text"
																		...
																		name="M_EMAIL" id="M_EMAIL" placeholder="Email" />
														...
														<div class="form-group">
															<label> 주소 </label> <input type="text"
																class="form-control form-control-solid form-control-lg"
																name="M_ADDRESS" placeholder="서울시 종로구 EZwork"
																 id="M_ADDRESS" /> 
														</div>
															...
															<div class="col-xl-6">
																...
																<div class="form-group">
																	<label> 상세주소 </label> <input type="text"
																		class="form-control form-control-solid form-control-lg"
																		name="M_ADDRESS2" placeholder="상세주소"
															...
															<div class="col-xl-6">
																<div class="form-group">
																	<label> 전공 </label> <input type="text"
																		class="form-control form-control-solid form-control-lg"
																		name="SC_MAJOR" placeholder="전공" id="SC_MAJOR" />
																		<span
																	class="form-text text-muted">
																	참고 : 경제금융학과 등 </span>
																</div>
															...
															<div class="col-xl-6">
																<div class="form-group">
																	<label> 소재지 </label> <input type="text"
																		class="form-control form-control-solid form-control-lg"
																		name="SC_ADDRESS" placeholder="주소" id="SC_ADDRESS" />
																		<span
																	class="form-text text-muted">
															...
															<div class="col-xl-6">
																<div class="input-group date">
																	<input type="text" class="form-control" readonly
																		value="29/70/2020" name="SC_GRAD_DAY" kt_datepicker_3" />
																	<div class="input-group-append">
																		<span class="input-group-text"> <i
																			class="la la-calendar"></i>
																		</span>
