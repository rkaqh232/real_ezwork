													...
													<div class="my-5 step" data-wizard-type="step-content"
														...
														<div class="form-group row">
															...
															<div class="col-lg-9 col-xl-9">
																<input
																	...
																	name="M_CODE" id="M_CODE" type="text" placeholder="${m.m_CODE}" 
														...
														<div class="form-group row">
															<label class="col-xl-3 col-lg-3 col-form-label">부서코드</label>
																...
																<input type="radio" name="M_PART_C" id="M_PART_C" value="${m.m_PART_C}" />A1 총무 <span></span>
																	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label> 
													...
													<!-- 직급코드 -->
														...
														<div class="form-group row">
															...
															<div class="col-lg-9 col-xl-9">
																<input
																	class="form-control form-control-solid form-control-lg"
																	name="M_NAME" type="text" id="M_NAME"  value="${m.m_NAME}" readonly/>
															</div>
														</div>
															...
															<div class="col-lg-4 col-md-9 col-sm-12">
																<div class="input-group date">
																	<input type="text" class="form-control"
																		placeholder="${m.m_BIRTH}" name="M_BIRTH" readonly/>
														...
														<div class="form-group row">
															...
															<div class="col-lg-9 col-xl-9">
																<div
																	...
																	<input type="text"
																		class="form-control form-control-solid form-control-lg"
																		name="M_MOBILE_TEL" id="M_MOBILE_TEL" value="${m.m_MOBILE_TEL}" />
																</div>
															...
															<div class="col-9">
																<div class="input-group input-group-solid">
																	...
																	<input type="text"
																		...
																		name="M_EMAIL" id="M_EMAIL"  value="${m.m_EMAIL}" />
														...
														<div class="form-group">
															<label> 주소 </label> <input type="text"
																class="form-control form-control-solid form-control-lg"
																name="M_ADDRESS" value="${m.m_ADDRESS}"
																 id="M_ADDRESS" /> 
														</div>
															...
															<div class="col-xl-6">
																<div class="form-group">
																	<label> 전공 </label> <input type="text"
																		class="form-control form-control-solid form-control-lg"
																		name="SC_MAJOR" value="${m.sC_MAJOR}" id="SC_MAJOR" />
																		<span
																	class="form-text text-muted">
																	참고 : 경제금융학과 등 </span>
																</div>
															...
															<div class="col-xl-6">
																...
																<div class="form-group">
																	<label> 학위 </label> <input type="text"
																		class="form-control form-control-solid form-control-lg"
																		name="SC_DEGREE" value="${m.sC_DEGREE}" 
																		id="SC_DEGREE" /><span
																	class="form-text text-muted">
															...
															<div class="col-xl-6">
																<div class="form-group">
																	<label> 소재지 </label> <input type="text"
																		class="form-control form-control-solid form-control-lg"
																		name="SC_ADDRESS" value="${m.sC_ADDRESS}"  id="SC_ADDRESS" />
																		<span
																	class="form-text text-muted">
															...
															<div class="col-xl-6">
																<div class="input-group date">
																	<input type="text" class="form-control" readonly
																		value="${m.sC_GRAD_DAY}" name="SC_GRAD_DAY" id=kt_datepicker_3" />
																	<div class="input-group-append">
																		<span class="input-group-text"> <i
																			class="la la-calendar"></i>
																		</span>
															...
															<div class="col-xl-6">
																<div class="form-group">
																	<label> 시험명 </label> <input type="text"
																		class="form-control form-control-solid form-control-lg"
																		name="LG_TEST" value="${LG_TEST}" id="LG_TEST" />
																		<span
																	class="form-text text-muted">
															...
															<div class="col-xl-6">
																<div class="form-group">
																	<label> 발급기관 </label> <input type="text"
																		class="form-control form-control-solid form-control-lg"
																		name="LG_ORGAN" value="${LG_ORGAN}" id="LG_ORGAN" />
																		<span
																	class="form-text text-muted">
														...
														<div class="row">
															...
															<div class="col-xl-6">
																<div class="form-group">
																	<label> 발급기관 </label> <input type="text"
																		class="form-control form-control-solid form-control-lg"
																		name="LI_ORGAN" value="${LI_ORGAN}"  id="LI_ORGAN" />
																		<span
																	class="form-text text-muted">
