           ...
           <td><%--제목 --%>
              <div>
                 <%--답변글 제목앞에 여백 처리 부분
                  ...
                  --%>
                  <c:if test="${b.no_RE_LEV != 0}"> <!-- 답글인 경우 -->
                  ...
                  <c:if test="${b.no_RE_LEV == 0}">   <!-- 원문인 경우 -->
                     &nbsp;
                  </c:if>
                  
                  <a href="./BoardDetailAction.ev?num=${b.NO_NO}">
                     ${b.no_TITLE}
                  </a>
              </div>
              </td>
              <td><div>${b.no_NAME}</div></td>
        ...
        <div class="rol">
          <ul class="pagination">
              <c:if test="${page <= 1 }">
               ...
               <c:if test="${page > 1}">
                 <li class="page-item">
                    <a href="./BoardList.no?page=${page-1}" 
