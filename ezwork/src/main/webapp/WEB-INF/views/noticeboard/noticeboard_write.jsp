			...
			<form action="Board_write_ok.no" method="post"
				...
				<div class="card-body">
					...
					<div class="form-group row">
						...
						<div class="col-lg-4">
							<input name="NO_NAME" id="board_name" value="인사팀" readOnly
					...
					<div class="form-group row">
						...
						<div class="col-lg-7">
							<textarea name ="NO_CONTENT" style="height: 325px" class="form-control" rows="3" placeholder="내용을 입력하세요"></textarea>
						</div>
					</div>
