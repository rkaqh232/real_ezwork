...
<div
         ...
         <div class="brand flex-column-auto" id="kt_brand">
            ...
            <button class="brand-toggle btn btn-sm px-0" id="kt_aside_toggle">
               <span class="svg-icon svg-icon svg-icon-xl"> <!--  아이콘   아이콘 아이콘 아이콘 아이콘 아이콘 아이콘 아이콘 아이콘 아이콘 아이콘 아이콘 아이콘 아이콘-->
                  <!-- <svg xmlns="http://www.w3.org/2000/svg"
                     ...
                     height="24px" viewBox="0 0 24 24" version="1.1">
                        ...
                        </svg>  --> <!--end::Svg Icon--> <!-- 아이콘 아이콘 아이콘  아이콘 아이콘 아이콘 아이콘 아이콘 아이콘 아이콘 아이콘 아이콘 아이콘 -->
               </span>
            </button>
            <!--end::Toolbar-->
         </div>
   ...
   <li class="menu-item menu-item-submenu" aria-haspopup="true"
                     ...
                     </span> <span class="menu-text">인사관리</span> <i class="menu-arrow"></i>
                  </a> 
            ...
            <!----------------------------------     하위 탭     ------------------------------------------>
                        ...
                        <ul class="menu-subnav">
                           ...
                           <li class="menu-item menu-item-submenu" aria-haspopup="true"
                              ...
                              </i> <span class="menu-text">인사정보</span> <i class="menu-arrow"></i>
                           </a>
                              <div class="menu-submenu">
                                 <i class="menu-arrow"></i>
                                 <ul class="menu-subnav">
...
<!--  근태관리  근태관리  근태관리  근태관리  근태관리  근태관리  근태관리  근태관리  근태관리  근태관리  근태관리  근태관리  근태관리  근태관리  근태관리  근태관리  근태관리  근태관리 근태관리  근태관리근태관리  근태관리 -->                     
                     ...
                     </span> <span class="menu-text">근태관리</span> 
                     <i class="menu-arrow"></i>
                     ...
                     <div class="menu-submenu">
                        ...
                        <ul class="menu-subnav">
                           ...
                           <li class="menu-item menu-item-submenu" aria-haspopup="true"
                              ...
                              class="menu-link menu-toggle"> <i
                                 class="menu-bullet menu-bullet-line"> <span></span>
                              </i> <span class="menu-text">근태관리</span> <i class="menu-arrow"></i>
                           </a>
                              <div class="menu-submenu">
                                 <i class="menu-arrow"></i>
                                 <ul class="menu-subnav">
                           ...
                           <li class="menu-item menu-item-submenu" aria-haspopup="true"
                              ...
                              class="menu-link menu-toggle"> <i
                                 class="menu-bullet menu-bullet-line"> <span></span>
                              </i> <span class="menu-text">휴가관리</span> <i class="menu-arrow"></i>
                           </a>
   ...
   <!-- -===================================================================================================================================== -->               
                  <li class="menu-item menu-item-active" aria-haspopup="true">
                     ...
                     </span> <span class="menu-text">메뉴 </span>
                  </a>
                  </li>
...
<!-- 전자 결재  전자 결재  전자 결재  전자 결재  전자 결재  전자 결재  전자 결재  전자 결재  전자 결재  전자 결재  전자 결재  전자 결재  전자 결재  전자 결재  전자 결재  전자 결재  전자 결재  전자 결재  전자 결재      -->
...
<!-- 일정 관리  일정 관리  일정 관리  일정 관리  일정 관리  일정 관리  일정 관리  일정 관리  일정 관리  일정 관리  일정 관리  일정 관리  일정 관리  일정 관리  일정 관리  일정 관리  일정 관리  일정 관리  일정 관리    -->
                  ...
                  <li class="menu-item menu-item-submenu" aria-haspopup="true"
                     ...
                     </span> <span class="menu-text">일정관리</span> <i class="menu-arrow"></i>
                  </a> 
...
<!-- 조직도 조직도  조직도  조직도  조직도  조직도  조직도  조직도  조직도  조직도  조직도  조직도  조직도  조직도  조직도  조직도  조직도  조직도  조직도  조직도  조직도  조직도  조직도  조직도  조직도  조직도  조직도    -->
...
<!-- 게시판  게시판  게시판  게시판  게시판  게시판  게시판  게시판  게시판  게시판  게시판  게시판  게시판  게시판  게시판  게시판  게시판  게시판  게시판  게시판  게시판  게시판  게시판  게시판  게시판  게시판  -->
                  ...
                  <li class="menu-item menu-item-submenu" aria-haspopup="true"
                     ...
                     </span> <span class="menu-text">게시판</span> <i class="menu-arrow"></i>
                  </a> 
...
<!--  메신저  메신저  메신저  메신저  메신저  메신저  메신저  메신저  메신저  메신저  메신저  메신저  메신저  메신저  메신저  메신저  메신저  메신저  메신저  메신저  메신저  메신저  메신저  메신저  메신저  -->
                  <li class="menu-item menu-item-submenu" aria-haspopup="true"
                     data-menu-toggle="hover"><a href="javascript:;"
                     class="menu-link menu-toggle"> <span
                        class="svg-icon menu-icon"> <!--begin::Svg Icon | path:assets/media/svg/icons/Layout/Layout-4-blocks.svg-->
                     ...
                     </span> <span class="menu-text">메신저</span> <i class="menu-arrow"></i>
                  </a> 
