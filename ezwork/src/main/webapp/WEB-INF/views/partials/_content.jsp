			...
			<div class="col-lg-6 col-xxl-4">
				...
				<div class="card card-custom  card-stretch gutter-b">
					...
					<div class="card-header border-0 py-5">
						<h3 class="card-title font-weight-bolder">내 정보</h3>
					</div>
						...
						<div class="card-spacer mt-n25">
							...
							<div class="text-center mb-10">
								...
								<div
									...
									<span class="font-weight-bold my-2">이재희</span> <span
										class="text-muted mb-2">주임</span>
								</div>
								<div>
									<div class="text-muted">010-2345-7897</div>
									<div class="text-muted">matt@fifestudios.com</div>
								</div>

								<div style="margin-top: 12px;"
									class="label label-light-info label-inline font-weight-bold label-lg">총무팀</div>
							</div>
							...
							<button type="submit" style="width: 160px"
								...
								id="end" formaction="OffTime.cm" disabled="">퇴근 등록</button>

							<div class="py-9" style="font-size: 15px;">
								<div
									class="d-flex align-items-center justify-content-between mb-2">
									<span class="font-weight-bold mr-2">현재시간 : </span> <span
										class="text-muted">Melbourne</span>
								</div>
								<div
									class="d-flex align-items-center justify-content-between mb-2">
									<span class="font-weight-bold mr-2">근무시작시간 :</span> <span
										href="#" class="text-muted">08:00</span>
								</div>
								<div
									class="d-flex align-items-center justify-content-between mb-2">
									<span class="font-weight-bold mr-2">근무종료시간 :</span> <span
										class="text-muted">미등록</span>
								</div>
							...
							<table class="table table-borderless table-vertical-center">
								...
								<tbody>
									<tr>
										...
										<td class="text-right"><span
											class="text-muted font-weight-500">ReactJs, HTML</span></td>
										<td class="text-right"><span
									...
									<tr>
										...
										<td class="text-right"><span
											...
											<span class="text-muted font-weight-bold">Paid</span></td>
										<td class="text-right"><span
											class="text-muted font-weight-500">Python, MySQL</span></td>
										<td class="text-right"><span
									...
									<tr>
										...
										<td class="text-right"><span
											...
											<span class="text-muted font-weight-bold">Paid</span></td>
										<td class="text-right"><span
											class="text-muted font-weight-500">Laravel, Metronic</span></td>
										<td class="text-right"><span
									...
									<tr>
										...
										<td class="text-right"><span
											...
											<span class="text-muted font-weight-bold">Paid</span></td>
										<td class="text-right"><span
											class="text-muted font-weight-bold">AngularJS, C#</span></td>
										<td class="text-right"><span
			...
			<div class="col-lg-6 col-xxl-4 order-1 order-xxl-1">
				...
				<div class="card card-custom card-stretch gutter-b">
					...
					<div class="card-header border-0 pt-5" style="margin-bottom: -35px;">
						<h3 class="card-title align-items-start flex-column">
							<span class="card-label font-weight-bolder text-dark">업무메모</span>
						</h3>
					</div>
					...
					<div class="card-body pt-8" id="memo"
						style="overflow-y: scroll; height: 150px;">
						<div class="form-group">
							<textarea class="form-control form-control-solid"
								placeholder="메모할 내용을 입력하세요" rows="3"></textarea>
						</div>
