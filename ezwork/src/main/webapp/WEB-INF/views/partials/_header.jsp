								...
								<div id="kt_header_menu" class="header-menu header-menu-mobile header-menu-layout-default">
									...
									<ul class="menu-nav">
										...
										<li class="menu-item menu-item-submenu" data-menu-toggle="click" aria-haspopup="true">
											<a href="javascript:;" class="menu-link menu-toggle">
												<span class="menu-text" onclick="location.href='wait.appr'"> 결재 </span>
												<i class="menu-arrow"></i>
											</a>
												...
												<ul class="menu-subnav">
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="javascript:;" class="menu-link">
															...
															<span class="menu-text" onclick="location.href='notice.bo'">공지 게시판</span>
														</a>
													</li>
													...
													<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
														<a href="javascript:;" class="menu-link menu-toggle">
															...
															<span class="menu-text" onclick="location.href='material.bo'">자료실</span>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="javascript:;" class="menu-link">
															...
															<span class="menu-text" onclick="location.href='free.bo'"> 인사 이동 알림</span>
														</a>
													</li>
													...
													<li class="menu-item" aria-haspopup="true">
														<a href="javascript:;" class="menu-link">
															...
															<span class="menu-text" onclick="location.href='BoardList.ev'">경조사 알림</span>
							...
							<div class="topbar">
								...
								<div class="topbar-item">
										<div class="btn btn-icon btn-clean btn-lg">
											<span class="svg-icon svg-icon-xl svg-icon-primary" onclick="location.href='list.hr'">
									...
									<div class="btn btn-icon btn-clean btn-lg mr-1">
										<span class="svg-icon svg-icon-xl svg-icon-info" onclick="location.href='notice.bo'">
									...
									<div class="btn btn-icon btn-clean btn-lg mr-1" data-toggle="modal">
										...
										<span class="svg-icon svg-icon-primary" onclick="location.href='update.hr'">
   										 <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
       										 <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
         									   <rect x="0" y="0" width="24" height="24"/>
								...
								<div class="topbar-item">
									...
									<div class="btn btn-icon w-auto btn-clean d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
										...
										<span class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3" id="M_CODE">${M_CODE } 님</span>
