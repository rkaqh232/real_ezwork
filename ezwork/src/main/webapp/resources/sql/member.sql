...
create table member(
	...
	M_WORK_C  				NUMBER,                -- 계약코드(아르바이트,계약직,정규직..)
	...
	M_GENDER 				varchar2(8) CHECK ( gender IN ('남','여') ),           -- 성별     boolean형 사용 불가능
	M_BIRTH  				date,                  -- 생년월일
	M_ARMY   				varchar2(5),           -- 군필여부 boolean형 사용 불가능
	M_MARRIAGE 				varchar2(5),           -- 결혼여부 boolean형 사용 불가능
